...
<div class="row" style="margin: 22px;">
  <div class="p-h-md p-v bg-white box-shadow pos-rlt col-lg-3 pull-right " style="border: 1px solid #e8ecf2;">
    <form class="input-group col-lg-12 pull-right">
      <input type="text" class="form-control no-border input-sm no-bg " maxlength="25" placeholder="Search New Reservation..." >
    ...
    <table class="table table-striped">
        <thead  style="background-color:#0E302B">
            <tr style="color:#ffffff">
                ...
                <th class="col-sm-2">Court Name:</th>
                <th class="col-sm-1">Time Slot</th>
        ...
        <tbody>
            <tr>
                ...
                <td class="col-sm-1">Court Name:</td>
                <td class="col-sm-1">Time Slot</td>
