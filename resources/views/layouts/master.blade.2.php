...
<body class="fixed-nav sticky-footer" id="page-top"  style="background-color:#0E302B">
  <!-- Navigation-->
  <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" id="mainNav" style="background-color:#0E302B">
    ...
    <ul class="sidenav-second-level collapse" id="collapseExamplePages">
      <li>
        <a href="{{url('/app_users')}}">App Users</a>
      </li>
      <li>
      ...
      <li>
        <a href="{{url('/upcoming_reservationns')}}">Upcoming Reservations</a>
      </li>
      <li>
        <a href="{{url('/past_reservationns')}}">Past Reservations</a>
      </li>
      <li>
        <a href="{{url('/cancelled_reservationns')}}">Cancelled Reservations</a>
      </li>
